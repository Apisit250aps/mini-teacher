...
type UseStudentCheckTableResult = {
	columns: ColumnDef<StudentCheckTableRow>[]
	tableData: StudentCheckTableRow[]
	tableLimit: number
	isLoading: boolean
}

export function useStudentCheckTable(): UseStudentCheckTableResult {
